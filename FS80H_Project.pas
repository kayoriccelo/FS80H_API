<Project xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
    <PropertyGroup>
        <ProjectGuid>{AB757E3E-B7F7-4FC9-8AD9-BD83C75D88C8}</ProjectGuid>
        <ProjectVersion>18.1</ProjectVersion>
        <FrameworkType>VCL</FrameworkType>
        <MainSource>FS80H_Project.dpr</MainSource>
        <Base>True</Base>
    ...
    <PropertyGroup Condition="'$(Base)'!=''">
        ...
        <SanitizedProjectName>FS80H_Project</SanitizedProjectName>
    ...
    <ItemGroup>
        ...
        <DCCReference Include="FS80H.pas">
            <Form>Form1</Form>
    ...
    <ProjectExtensions>
        ...
        <BorlandProject>
            <Delphi.Personality>
                <Source>
                    <Source Name="MainSource">FS80H_Project.dpr</Source>
                </Source>
                <Excluded_Packages>
            ...
            <Deployment Version="3">
                <DeployFile LocalName="Win32\Debug\FS80H_Project.exe" Configuration="Debug" Class="ProjectOutput">
                    <Platform Name="Win32">
                        <RemoteName>FS80H_Project.exe</RemoteName>
